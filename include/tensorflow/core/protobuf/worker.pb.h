...
class CompleteGroupResponse :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& task_name() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_task_name();
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> device_name_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> task_name_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr device_type_;
